                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 mt-3 row ms-5">
                            ...
                            <div class="col-sm-8">
                                <input type="password"
                                    ...
                                    value="<?= isset($_POST['password']) ? '' : $user['password']; ?>">
                        ...
                        <div class="mb-3 mt-3 row ms-5">
                            ...
                            <div class="col-sm-8">
                                <input type="text"
                                    ...
                                    name="nama" value="<?= isset($_POST['nama']) ? $_POST['nama'] : $user['nama']; ?>">
                        ...
                        <div class="mb-3 mt-3 row ms-5">
                            ...
                            <div class="col-sm-8">
                                <input type="text"
                                    ...
                                    value="<?= isset($_POST['telepon']) ? $_POST['telepon'] : $user['telepon']; ?>">
                        ...
                        <div class="mb-3 mt-3 row ms-5">
                            ...
                            <div class="col-sm-8">
                                <textarea <?= isset($errors['alamat']) ? '' : 'style="border: 1px solid black;"'; ?>
                                    ...
                                    rows="2"><?= isset($_POST['alamat']) ? $_POST['alamat'] : $user['alamat']; ?></textarea>
                        ...
                        <div class="d-flex justify-content-end me-5">
                            <a class="btn btn-secondary mt-3 px-4 me-3" style="border-radius: 15px;"
                                href="../manajer/index.php">Kembali</a>
