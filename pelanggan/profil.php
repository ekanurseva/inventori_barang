            ...
            <div class="d-flex">
                ...
                <div class="contents px-3 py-3">
                    ...
                    <form method="post" action="">
                        ...
                        <div class="mb-3 mt-3 row ms-5">
                            <label for="email" class="col-sm-3 me-0 col-form-label">Email
                                :</label>
                            <div class="col-sm-7">
                        ...
                        <div class="mb-3 mt-3 row ms-5">
                            <label for="noHp" class="col-sm-3 me-0 col-form-label">Instansi :</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="noHp">
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end me-5">
                            <a class="btn btn-secondary mt-3 px-4 me-3" style="border-radius: 15px;"
                                href="../pelanggan/index.php">Kembali</a>
