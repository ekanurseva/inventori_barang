                        ...
                        <div class="mb-3 mt-3 row ms-5">
                            ...
                            <div class="col-sm-8">
                                <input type="text"
                                    ...
                                    name="merk" value="<?= isset($_POST['merk']) ? $_POST['merk'] : $data['merk']; ?>">
                        ...
                        <div class="mb-3 mt-3 row ms-5">
                            ...
                            <div class="col-sm-8">
                                <input type="text"
                                    ...
                                    value="<?= isset($_POST['nama_barang']) ? $_POST['nama_barang'] : $data['nama_barang']; ?>">
                        ...
                        <div class="mb-3 mt-3 row ms-5">
                            ...
                            <div class="col-sm-8">
                                <input type="text"
                                    ...
                                    value="<?= isset($_POST['kategori']) ? $_POST['kategori'] : $data['kategori']; ?>">
                        ...
                        <div class="mb-3 mt-3 row ms-5">
                            ...
                            <div class="col-sm-8">
                                <input type="text"
                                    ...
                                    value="<?= isset($_POST['gudang']) ? $_POST['gudang'] : $data['gudang']; ?>">
                        ...
                        <div class="mb-3 mt-3 row ms-5">
                            ...
                            <div class="col-sm-8">
                                <input type="text"
                                    ...
                                    name="rak" value="<?= isset($_POST['rak']) ? $_POST['rak'] : $data['rak']; ?>">
                        ...
                        <div class="mb-3 mt-3 row ms-5">
                            ...
                            <div class="col-sm-8">
                                <input type="number"
                                    ...
                                    name="stok" value="<?= isset($_POST['stok']) ? $_POST['stok'] : $data['stok']; ?>">
                        ...
                        <div class="mb-3 mt-3 row ms-5">
                            ...
                            <div class="col-sm-8">
                                <input type="text"
                                    ...
                                    value="<?= isset($_POST['satuan']) ? $_POST['satuan'] : $data['satuan']; ?>">
                        ...
                        <div class="mb-3 mt-3 row ms-5">
                            ...
                            <div class="col-sm-8">
                                <input type="number"
                                    ...
                                    name="harga"
                                    value="<?= isset($_POST['harga']) ? $_POST['harga'] : $data['harga']; ?>">
                        ...
                        <div class="mb-3 mt-3 row ms-5">
                            ...
                            <div class="col-sm-8">
                                <textarea <?= isset($errors['keterangan']) ? '' : 'style="border: 1px solid black;"'; ?>
                                    ...
                                    rows="2"><?= isset($_POST['keterangan']) ? $_POST['keterangan'] : $data['keterangan']; ?></textarea>
